...
{% include warning.html text="Be careful when operating the hole saw. Blade must not be touching box when drilling starts. If you have never used a hole saw before please seek assistance. See note below." %}

{% include note.html text="Note, you need the drill to have speed when it makes contact with the plastic so you may have to ease off the pressure and reapply as necessary." %}
...
{% include picture.html src="computer_box/IMG_6939.jpg" caption="The computer control box with the cable feed holes drilled out." %}
